...
<h2 class="text-light display-6">Author Name : Nyumart</h2>
...
<li class="list-group-item">
<a style="font-size:20px;" href="#" target="_blank" > <i class="fa fa-tasks"></i> My Previous Work <span class="badge badge-danger pull-right m-l-10 m-b-10" style="font-size:20px;" >www.mayurik.com</span></a>
</li>
<li class="list-group-item">
