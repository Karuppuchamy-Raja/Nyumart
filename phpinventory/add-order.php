          ...
          <tbody>
            ...
            for($x = 1; $x < 2; $x++) { ?>
              ...
              <td style="padding-left:20px;">
                ...
                <td style="padding-left:20px;">
                  <div class="form-group">
                  <input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="on" class="form-control" min="1" />
                  </div>
                </td>
                <td >                 
...
<td >
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace">
                <option value="">~~SELECT~~</option>
                <option value="1">In Ingur</option>
                <option value="2">In Perundurai</option>
              </select>
            </div>
                                               </div>
                                            </div>
        <div class="form-group submitButtonFooter">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <button type="reset" class="btn btn-danger btn-flat m-b-30 m-t-30" onclick="printOrder('+response.order_id+')"><i class="glyphicon glyphicon-erase"></i> Print</button>
          </div>
        </div>
  ...
  if(orderId) {   
    ...
    $.ajax({
      ...
      success:function(response) {
        ...
        var mywindow = window.open('', 'Nyumart Invoice System', 'height=400,width=600');
